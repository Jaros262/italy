...
$(document).ready(function(){
    ...
    $(".city").on("click", function(){
        if($("#mesta:checked").val()) {
            ...
            <div class="col-2">
                <img src="img/${towns.sign}" class="img-fluid">
            </div>
            <div class="col-10">
                ${towns.text}
            </div>
