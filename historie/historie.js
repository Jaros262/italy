...
persons.forEach((persons)=>{
    ...
    <table class="table table-inverse table-bordered" id="personsInfoFunction">
        <thead class="thead-inverse">
            <tr>
                <th class="persons-date">${persons.date}</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td>
                    <h4 class="persons-name">${persons.name}</h4>
                    <p class="persons-detail">${persons.detail}</p>
                </td>
            </tr>
            <tr>
                <td>Odkaz:<a href="${persons.url}" target="_new" > ${persons.url}</a> hustý odkaz</a></td>
            </tr>
        </tbody>
    </table>          
    </div>
